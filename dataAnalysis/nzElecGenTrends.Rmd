...
if(local){ # set data storage location
  gcParams$wgenDataLoc <- path.expand("~/Data/NZ_EA_EMI/gridGen/raw/")
} else {
 ...
 * Anderson, B. (`r lubridate::year(Sys.Date())`) _NZ Electricity Generation Trends 1998-2018_, University of Otago/University of Southampton: Dunedin.
