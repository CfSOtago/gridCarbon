...
```{r descData}
t <- gridGenDT[, .(mGen = mean(GW),
                   sGen = sum(GWh)/1000, # TWh
                 mCI = mean(CARBON_INTENSITY),
                 sC = sum(totalC02e_T)/1000000, # for comparison with https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/875508/final-greenhouse-gas-emissions-tables-2018.xlsx
                 maxDate = max(obsDate),
...
sC <- paste0("Total annual CO2e (MtCO2e)")
