...
```{r timeVariationGWh, fig.cap=paste0("timeVariation plots for half-hourly GWh generation comparing pre/lockdown 2020 with the same months in previous years starting in ", cutYear)}
