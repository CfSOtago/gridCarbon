...
ggplot2::ggsave(filename = "allGWPlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "allGCIPlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "allCO2ePlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "embeddedSolarGWPlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "gridWindGWPlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "embeddedWindGWPlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
