...
p <- out$plot$day
png(filename=here::here("docs/plots/openAirDailyGW.png"))
plot(p)
dev.off()
#ggplot2::ggsave(here::here("docs/plots/openAirDailyGW.png"), p)
p <- out$plot$hour
png(filename=here::here("docs/plots/openAirHourlyGW.png"))
plot(p)
dev.off()
p <- out$plot$day.hour
png(filename=here::here("docs/plots/openAirWeekdaysGW.png"), width = 800, height = 600)
plot(p)
dev.off()
p <- out$plot$day.hour
svg(filename=here::here("docs/plots/openAirWeekdaysGW.svg"), width = 800, height = 600)
plot(p)
dev.off()
```
...
# Extract the plots we want...
p <- out$plot$day
png(filename=here::here("docs/plots/openAirDailyCI.png"))
plot(p)
dev.off()
#ggplot2::ggsave(here::here("docs/plots/openAirDailyGW.png"), p)
p <- out$plot$hour
png(filename=here::here("docs/plots/openAirHourlyCI.png"))
plot(p)
dev.off()
p <- out$plot$day.hour
png(filename=here::here("docs/plots/openAirWeekdaysCI.png"), width = 800, height = 600)
plot(p)
dev.off()
p <- out$plot$day.hour
svg(filename=here::here("docs/plots/openAirWeekdaysCI.svg"), width = 800, height = 600)
plot(p)
dev.off()
```
...
# Extract the plots we want...
p <- out$plot$day
png(filename=here::here("docs/plots/openAirDailyCO2e_T.png"))
plot(p)
dev.off()
#ggplot2::ggsave(here::here("docs/plots/openAirDailyGW.png"), p)
p <- out$plot$hour
png(filename=here::here("docs/plots/openAirHourlyCO2e_T.png"))
plot(p)
dev.off()
p <- out$plot$day.hour
png(filename=here::here("docs/plots/openAirWeekdaysCO2e_T.png"), width = 800, height = 600)
plot(p)
dev.off()
p <- out$plot$day.hour
svg(filename=here::here("docs/plots/openAirWeekdaysCO2e_T.svg"), width = 800, height = 600)
plot(p)
dev.off()
```
