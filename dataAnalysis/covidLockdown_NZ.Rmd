...
p <- oaMWh$plot
png(filename=here::here("docs/plots/openAir_NZ_TheilSenMWhPlot.png"), 
    width = 960, units = "px")
...
of <- paste0(here::here("docs", "plots", "NZ_TotalElectricityGeneration.jpeg"))
...
baselineDT[, hpCurrentMeanMWh := hpCurrentTotalMW/2]

# model to 100%
newHPsOwner <- nOwned * (1-0.4) # 40% already have them
newHPsRenter <- nRented * (1-0.25) # 40% already have them
