...
#Test2
myPlot <- ggplot2::ggplot(shortDT, aes(x= rDateTime)) +
  geom_line(aes(y = Coal, colour = grey), stat = "identity")+
  geom_line(aes(y = Diesel, colour = black))+
  geom_line(aes(y = Gas, colour = pruple))+
  geom_line(aes(y = Geo, colour = green))+
  geom_line(aes(y = Hydro, colour = blue))+
  geom_line(aes(y = Wind, colour = yellow))+
  geom_line(aes(y = Wood, colour = brown))
myPlot
