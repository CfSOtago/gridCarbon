...
myPlotTot <- ggplot2::ggplot(plotDT, aes(x= dateTime)) +
  ...
  #geom_smooth(aes(y=`2019`, colour = "2019"))+
  #geom_smooth(aes(y=`2018`, colour = "2018"))+
   geom_line(aes(y=`coal20`, colour = "coal20"))+
   geom_line(aes(y=`coal19`, colour = "coal19"))+ 
   geom_line(aes(y=`coal18`, colour = "coal18"))+
  scale_color_manual(legend_title, values = c(`coal20`='#3498DB',`coal19`='#229954', `coal18`='#CA6F1E'))+
  theme(axis.text.x = element_text(colour = "black"),
        axis.text.y = element_text(colour ="black"))+
  labs(x='Extracted days for March', y='Power (MW)')+
 # facet_grid(date ~ .) +
