...
myPlotTot <- ggplot2::ggplot(plotDT, aes(x= rDateTime )) +
  ...
  geom_smooth(aes(y=totalMW, colour=rMonth))+
...
myPlotTot <- ggplot2::ggplot(plotDT, aes(x= dateTime)) +
  ...
  #geom_smooth(aes(y=`2019`, colour = "2019"))+
  #geom_smooth(aes(y=`2018`, colour = "2018"))+
   geom_line(aes(y=`gas20`, colour = "gas20"))+
   geom_line(aes(y=`gas19`, colour = "gas19"))+ 
   geom_line(aes(y=`gas18`, colour = "gas18"))+
  scale_color_manual(legend_title, values = c(`gas20`='#3498DB',`gas19`='#229954', `gas18`='#CA6F1E'))+
  theme(axis.text.x = element_text(colour = "black"),
        axis.text.y = element_text(colour ="black"))+
  labs(x='Extracted days for February', y='Power (MW)')+
 # facet_grid(date ~ .) +
...
plotDT <- summaryDT[Fuel_Code=="Gas"]
...
myPlotTot <- ggplot2::ggplot(plotDT, aes(x= dateTime)) +
 ...
 scale_color_manual(legend_title, values = c("gas20"='#3498DB',"gas19"='#229954', "gas18"='#CA6F1E', labels =c("a", "b", "c")))+
 theme(axis.text.x = element_text(colour = "black"),
        axis.text.y = element_text(colour ="black"))+
  labs(x='Extracted days for February', y='Power (MW)')+
  scale_x_datetime(date_breaks = '3 days',
