...
```
Figure \@ref(fig:totalgen) shows total generation data for January and February. In addition, a linear model and its error distribution is highlighted in blue. In summary, variation in electriicty generation was particularly apparent in February.
...
legend_title <- "Month"
myPlotTot <- ggplot2::ggplot(totalgenDT, 
                             aes(x= rDateTime,
                                 y = totalMW, 
                                 colour = rMonth)) +
  geom_line() +
