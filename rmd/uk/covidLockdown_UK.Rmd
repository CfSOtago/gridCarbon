...
p <- oaGWFuels$plot
png(filename=here::here("docs/plots/openAir_UK_TheilSenoaMWFuelsPlot.png"), 
    width = 960, units = "px")
...
ggplot2::ggsave(filename = "UK_allGWPlotTile.png", path = here::here("docs", "plots"), 
...
ggplot2::ggsave(filename = "allGWlineBySeason.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
...
ggplot2::ggsave(filename = "UK_allGWhlineBySeason.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "UK_allCIPlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "UK_allCO2ePlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
...
ggplot2::ggsave(filename = "UK_meanGWhBySeason_2019.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "gridSolarGWPlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "UK_embeddedSolarGWPlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "UK_gridWindGWPlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
...
p <- addLockdownRect(p, yMin = yMin, yMax = yMax, 
                from = gcParams$UKlockDownStartDate, to = max(gridGenDT$obsDate))
ggplot2::ggsave(filename = "UK_embeddedWindGWPlotTile.png", path = here::here("docs", "plots"), 
                plot = p, width = 9, units = "in")
p
```
