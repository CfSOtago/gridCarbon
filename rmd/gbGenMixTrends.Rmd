...
The smoothed curves are estimated for each year via gam. The lines terminate at the maximum value for the year. I'm still trying to decide if they tell us anything useful.
...
Again the smoothed curve is estimated for each year (and demand period) via gam. 
